...
//DescriptionTotal TODO
func (r *Response) DescriptionTotal() string {
	total := []string{}
...
//New TODO
func New(token string) *OpenWeather {
	return &OpenWeather{
		token: token,
	}
}
...
func (w *OpenWeather) ByName(city string) (*Response, error) {
...
func (w *OpenWeather) transformStringToResponse(body string) (resp *Response, err error) {
